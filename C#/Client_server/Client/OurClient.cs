using System.Net.Sockets; // Позволяет работать с TCP
using System.Text;
...
namespace Client
{
    class OurClient
    {
        ...
        public OurClient()
        {
            client = new TcpClient("127.0.0.1", 5555); // Этот IP - это localhost, port должен быть одинаковым у клиента и сервера
